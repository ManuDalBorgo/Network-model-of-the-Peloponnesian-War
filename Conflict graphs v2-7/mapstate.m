classdef mapstate
    ...
    methods
        ...
        function obj = conquer(obj, victor, vanquished, node, delta)
            ...
            obj.resources(affectednodes) = obj.resources(affectednodes) * (1 - delta);
        end
        
        function obj = attack(obj, attackingnode, defendingnode, gamma, delta)
            ...
            evaluation = evaluateattack(attackerresources, defenderresources, gamma);
            if evaluation == 1
                winner = attacker;
                loser = defender;
                node = defendingnode;
            ...
            obj = conquer(obj, winner, loser, node, delta);
        end
        ...
        function plothandle = plot(obj)
            ...
            plothandle = plot(temp_graph, 'MarkerSize', 10*sqrt(obj.resources), ...
                'NodeCData', obj.nodeowners/obj.numberplayers, 'NodeLabelMode', 'manual');
